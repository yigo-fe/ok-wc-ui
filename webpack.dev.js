 ...
 * @LastEditors: 付静
 * @LastEditTime: 2021-07-12 20:17:47
  ...
  devServer: {
    ...
    proxy: {
      '/apps/api': {
        ...
        headers: {
          Cookie:
            'tenant_id=test; local=zh-CN; designertoken=fe5f2cdf-bf83-4fab-8a65-cc510780ef53; egoToken=82e4d694-6e47-4302-9665-5748bbc341a2',
        },
      },
    },
  },
