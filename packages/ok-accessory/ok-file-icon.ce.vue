<template>
	<span ref="showFileIcon" class="ok-file-icon ok-file-icon-root">
		<img
			:src="fileIcon"
			:style="{ height: height, width: 'auto', 'vertical-align': 'middle' }"
			class="ok-file-icon-img"
			:class="{ 'hover-bigger': hoverBigger }"
		/>
	</span>
</template>
<script lang="ts">
...
import eml from '../assets/file-icon/icon_file-eml_colorful.svg'
